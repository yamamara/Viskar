...
import { type Module, type Lesson, type Stage, type TestCase } from "@/lib/lessons-data"
              ...
              if (l.id === lessonId) {
                return {
                  ...
                  stages: l.stages.map((s) => {
                    if (s.id === stageId) {
                      const newTestCase: TestCase = { input: "", expectedOutput: "", description: "New Test Case" }
                                         ...
                                         {stage.type === 'exercise' && (
                                           <>
                                             ...
                                             <div className="space-y-3 pt-2 animate-in">
                                                <div className="flex items-center justify-between">
                                                   <h5 className="text-xs font-bold uppercase text-foreground/70">Test Cases (Regex) - Optional</h5>
                                                ...
                                                {stage.testCases?.map((tc, idx) => (
                                                  <div key={idx} className="grid grid-cols-12 gap-2 items-start bg-card p-2 border border-border rounded-md">
                                                     <div className="col-span-11 space-y-2">
                                                        ...
                                                        />
                                                        <Input
                                                          placeholder="Expected Output (Regex)"
